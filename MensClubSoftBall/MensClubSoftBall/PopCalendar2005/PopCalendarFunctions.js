...
function __PopCalShowCalendar(_o,_span)
{
	...
	// ---------------------
	var _calOnjName = o.getAttribute("Calendar")
	var _estr = "if(typeof("+_calOnjName+")=='undefined'){_calOnjName = 'dpopCalenderStartDate';}"
	eval(_estr);
	var _PopCal=eval(_calOnjName)
	o.calendar = _calOnjName	
	document.getElementById(_o).setAttribute("Calender", _calOnjName);
	// ---------------------
